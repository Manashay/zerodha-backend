...
app.use(
    cors({
        origin: ["https://zerodha-frontend-8jsv.onrender.com", "https://zerodha-dashboard-ks5n.onrender.com", "http://localhost:3000"],
...
app.put("/upadateHolding/:id", async(req, res) => {
    try {
        const { qty } = req.body;
        await HoldingsModel.findByIdAndUpdate(req.params.id, { qty: qty });
